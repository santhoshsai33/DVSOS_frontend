export const ROUTES = {
  ...
  ADMIN_MASTER_STATES_EDIT: '/master-states/:id/edit',
  ADMIN_MASTER_DISTRICTS: '/master-districts',
  ADMIN_MASTER_DISTRICTS_NEW: '/master-districts/new',
  ADMIN_MASTER_DISTRICTS_EDIT: '/master-districts/:id/edit',
  ...
  ADMIN_LOCATIONS_VIEW: '/locations/:id',
